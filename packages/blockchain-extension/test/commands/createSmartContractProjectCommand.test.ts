...
describe('CreateSmartContractProjectCommand', () => {
    ...
    beforeEach(async () => {
        ...
        showQuickPickItemStub.resolves({label: UserInputUtil.GENERATE_DEFAULT_CONTRACT, description: UserInputUtil.GENERATE_DEFAULT_CONTRACT_DESCRIPTION, data: 'public'});
    });
    afterEach(() => {
        mySandBox.restore();
    });
