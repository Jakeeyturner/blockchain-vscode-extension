...
module.exports = function(): any {
    ...
    this.Given(/the( private)? contract hasn't been created already/, this.timeout, async (_privateOrNot: string) => {
    ...
    this.Then(/a new (private )?contract directory should exist/, this.timeout, async (_privateOrNot: string) => {
